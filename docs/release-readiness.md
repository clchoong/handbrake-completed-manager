...
Version 0.8.1 was validated as a self-contained Windows x64 open-source release candidate on 22 July 2026.
...
- Packaged executable metadata reports product version `0.8.1` and company `clchoong`.

The validated archive is `HandBrake-Completed-Manager-0.8.1-win-x64.zip`. Its size is 116,233,187 bytes and its SHA-256 checksum is:
...
.\scripts\publish-portable.ps1 -Version 0.8.1
```
